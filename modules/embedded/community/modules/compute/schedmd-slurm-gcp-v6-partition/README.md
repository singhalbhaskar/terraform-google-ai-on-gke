...
|------|-------------|------|---------|:--------:|
| exclusive | Exclusive job access to nodes. When set to true nodes execute single job and are deleted<br>after job exits. If set to false, multiple jobs can be scheduled on one node. | `bool` | `true` | no |
...
| nodeset\_dyn | Details of a dynamic nodesets in this partition |
| nodeset\_tpu | Details of a TPU nodesets in this partition |
